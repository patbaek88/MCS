...
if st.button("Predict"):
    ...
    if num_pc >= 3:
        ...
        ax.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, label = 'Selected Material')
        ax.scatter(x_ex1, y_ex1, z_ex1,color = 'orange', alpha = 1, label = 'Selected Material')
        ax.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, label = 'Selected Material')
        ax.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, label = 'Selected Material')
        ax.scatter(x_ex4, y_ex4, z_ex4,color = 'orange', alpha = 1, label = 'Selected Material')
        ...
        ax_xy.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_xy.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_xy.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_xy.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_xy.scatter(x_ex4, y_ex4, z_ex4, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ...
        ax_yz.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_yz.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_yz.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_yz.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_yz.scatter(x_ex4, y_ex4, z_ex4, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_yz.scatter(xm, ym, zm , s=100, color = 'orange', alpha = 1, marker='*', label = 'Mixture')
        ...
        ax_zx.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^', label = 'Selected Material')
        ax_zx.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_zx.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_zx.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_zx.scatter(x_ex4, y_ex4, z_ex4, color = 'orange', alpha = 1, marker='^',label = 'Selected Material')
        ax_zx.scatter(xm, ym, zm , s=100, color = 'orange', alpha = 1, marker='*', label = 'Mixture')
        ...
        plt.scatter(x_api, y_api, color = 'black', alpha = 0.5, label = 'Selected Material')
        plt.scatter(x_ex1, y_ex1, color = 'black', alpha = 0.5, label = 'Selected Material')
        plt.scatter(x_ex2, y_ex2, color = 'black', alpha = 0.5, label = 'Selected Material')

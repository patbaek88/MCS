...
#    model_acc = round(accuracy_score(y_test, model_pred), 4)
    ...
    if num_pc >= 3:
        ...
        ax.scatter(x1, y1, z1, color = 'b', alpha = 0.5, label = 'Class 1', s= 10)
        ax.scatter(x2, y2, z2, color = 'g', alpha = 0.5, label = 'Class 2', s= 10)
        ax.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= 10)
        ax.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= 10)
        ax.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= 10)
        ax.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= 10)
        ax.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= 10)

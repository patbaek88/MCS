...
if st.button("Predict"):
    ...
    if num_pc >= 3:
        ...
        ax_xy.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^', label = 'Selected API')
        ax_xy.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^', label = 'Selected Filler 1')
        ...
        ax_yz.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^',label = 'Selected API')
        ax_yz.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^',label = 'Selected Filler 1')
        ax_yz.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, marker='^', label = 'Selected Filler 2')
        ax_yz.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, marker='^', label = 'Selected Binder')
        ax_yz.scatter(x_ex4, y_ex4, z_ex4, color = 'orange', alpha = 1, marker='^', label = 'Selected Disintegrant')
        ...
        ax_zx.scatter(x_api, y_api, z_api, color = 'orange', alpha = 1, marker='^', label = 'Selected API')
        ax_zx.scatter(x_ex1, y_ex1, z_ex1, color = 'orange', alpha = 1, marker='^',label = 'Selected Filler 1')
        ax_zx.scatter(x_ex2, y_ex2, z_ex2, color = 'orange', alpha = 1, marker='^',label = 'Selected Filler 2')
        ax_zx.scatter(x_ex3, y_ex3, z_ex3, color = 'orange', alpha = 1, marker='^',label = 'Selected Binder')
        ax_zx.scatter(x_ex4, y_ex4, z_ex4, color = 'orange', alpha = 1, marker='^',label = 'Selected Disintegrant')

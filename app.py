...
#    model_acc = round(accuracy_score(y_test, model_pred), 4)
    ...
    if num_pc >= 3:
        ...
        ax.scatter(x1, y1, z1, color = 'b', alpha = 0.5, label = 'Class 1', s= spot_size)
        ax.scatter(x2, y2, z2, color = 'g', alpha = 0.5, label = 'Class 2', s= spot_size)
        ax.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= spot_size)
        ax.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= spot_size)
        ax.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= spot_size)
        ax.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= spot_size)
        ax.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= spot_size)
        ...
        ax_xy.scatter(x1, y1, z1, color = 'b', alpha = 0.5, label = 'Class 1', s= spot_size)
        ax_xy.scatter(x2, y2, z2, color = 'g', alpha = 0.5, label = 'Class 2', s= spot_size)
        ax_xy.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= spot_size)
        ax_xy.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= spot_size)
        ax_xy.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= spot_size)
        ax_xy.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= spot_size)
        ax_xy.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= spot_size)
        ...
        ax_yz.scatter(x1, y1, z1, color = 'b', alpha = 0.5, label = 'Class 1', s= spot_size)
        ax_yz.scatter(x2, y2, z2, color = 'g', alpha = 0.5, label = 'Class 2', s= spot_size)
        ax_yz.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= spot_size)
        ax_yz.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= spot_size)
        ax_yz.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= spot_size)
        ax_yz.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= spot_size)
        ax_yz.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= spot_size)
        ...
        ax_zx.scatter(x1, y1, z1, color = 'b', alpha = 0.5, label = 'Class 1', s= spot_size)
        ax_zx.scatter(x2, y2, z2, color = 'g', alpha = 0.5, label = 'Class 2', s= spot_size)
        ax_zx.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= spot_size)
        ax_zx.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= spot_size)
        ax_zx.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= spot_size)
        ax_zx.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= spot_size)
        ax_zx.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= spot_size)
        ...
        spot_size = 5
        plt.scatter(x1, y1, color = 'b', alpha = 0.5, label = 'Class 1', s= spot_size)
        plt.scatter(x2, y2, color = 'g', alpha = 0.5, label = 'Class 2', s= spot_size)
        plt.scatter(x31, y31, z31, color = 'gold', alpha = 0.5, label = 'Class 3.1', s= spot_size)
        plt.scatter(x32, y32, z32, color = 'orange', alpha = 0.5, label = 'Class 3.2', s= spot_size)
        plt.scatter(x33, y33, z33, color = 'firebrick', alpha = 0.5, label = 'Class 3.3', s= spot_size)
        plt.scatter(x34, y34, z34, color = 'red', alpha = 0.5, label = 'Class 3.4', s= spot_size)
        plt.scatter(x4, y4, z4, color = 'magenta', alpha = 0.5, label = 'Class 4', s= spot_size)

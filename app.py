...
if st.button("Predict"):
    ...
    if num_pc >= 3:
        ...
        plt.scatter(x_api, y_api, color = 'black', alpha = 0.5)
        plt.scatter(x_ex1, y_ex1, color = 'black', alpha = 0.5)
        plt.scatter(x_ex2, y_ex2, color = 'black', alpha = 0.5)
        plt.scatter(x_ex3, y_ex3, color = 'black', alpha = 0.5)
        plt.scatter(x_ex4, y_ex4, color = 'black', alpha = 0.5)
